...
const pointLight = new THREE.PointLight(0xfffc00, 0.5, 3)
...
// to move spotlight we have to add target to a scene and move it
...
const hemishpereLightHelper = new THREE.HemisphereLightHelper(hemisphereLight, 0.2)
